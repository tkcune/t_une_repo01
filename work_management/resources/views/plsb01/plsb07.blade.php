     ...
     <div class="row">
         ...
         <div class="col-4" style="display:inline-flex;">
             ...
             <form action="{{ route('pssb01.search',[session('client_id'),'sb00000000'])}}" method="post">
                 ...
                 <input type="search" name="search2" class="top" maxlength="32" placeholder="人員検索" value="{{ $_POST['search2'] }}">
                 @else
                 <input type="search" name="search2" class="top" maxlength="32" placeholder="人員検索">
                 @endif
