...
class ProjectionDataBase
{
    ...
    public function getDepartmentList($client, $select_id)
    {
        ...
        $data = DB::select(
            'SELECT ta1.client_id,ta1.projection_id AS department_id ,bs1.responsible_person_id,bs1.name,bs1.status,bs1.management_personnel_id,bs1.operation_start_date,
                    ...
                    where ta1.client_id = ? and ks1.high_id = ? order by bs1.department_id',
            [$client, $select_id]
        );
    ...
    public function getDepartmentSearch($client, $select_id, $search)
    {
        ...
        $data = DB::select(
            'SELECT ta1.client_id,ta1.projection_id AS department_id,bs1.responsible_person_id,bs1.name,bs1.status,bs1.management_personnel_id,bs1.operation_start_date,
                    ...
                    inner join dcji01 as ji1 on bs1.management_personnel_id = ji1.personnel_id
                    inner join dcji01 as ji2 on ji1.management_personnel_id = ji2.personnel_id
                    where ta1.client_id = ? and ks1.high_id = ? and bs1.name like ? order by bs1.department_id',
    ...
    public function getPersonnelList($client, $select_id)
    {
        ...
        $data = DB::select(
            'SELECT ta1.client_id,ta1.projection_id AS personnel_id,ji1.name,ji1.email,ji1.password,ji1.password_update_day,
    ...
    public function getBoardList($client, $select_id)
    {
        ...
        $data = DB::select(
            'SELECT ta1.client_id,ta1.projection_id AS board_id,kb1.name,kb1.status,kb1.management_personnel_id,
                                ...
                                where ta1.client_id = ? and high_id = ? order by kb1.board_id',
            [$client, $select_id]
        );
     ...
     * @return $data
     */
    public function getSpaceList($client, $select_id)
    {
    ...
    public function getProjectionId($client, $select_id)
    {
        ...
        $data = DB::select(
            'select projection_id from dccmta where client_id = ?
                    and projection_source_id = ?',
            [$client, $select_id]
        );
    ...
    public function delete($client, $projection_id)
    {
        ...
        DB::delete(
            'delete from dccmta where client_id = ? and projection_id = ?',
