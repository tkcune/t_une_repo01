<div class="row">
    ...
    @if(isset($click_department_high))
    <div class="col" style="margin-top:5px;">
        <p>上位:<a href="{{ route('plbs01.show',[session('client_id'),$click_department_data->high_id])}}" data-toggle="tooltip" title="クリックにより、上位部署に遷移します">{{$click_department_high[0]->name}}</a></p>
    </div>
    @endif
</div>