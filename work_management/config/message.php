...
return [
            ...
            'mhcmer0011' => '配下部署に移動は出来ません',
            'mhcmer0012' => '英数字、ひらがな、カタカナ、漢字で入力してください',
            'mhcmer0013' => '不正な入力が行われました',
            'mhcmer0014' => '郵便番号はハイフン不要、7桁で入力してください',
            'mhcmer0015' => '有効なURLではありません',
            'mhcmer0016' => 'URLの文字数が255文字を超えています。短縮してください。',
            'mhcmer0017' => '都道府県部分は32文字以内で入力してください',
            'mhcmer0018' => '番地部分は32文字以内で入力してください',
            'mhcmer0019' => '作業場所名は32文字以内で入力してください',
            'mhcmer0020' => '備考欄は512文字以内で入力してください',
            ...
            'mhfier0001' => 'ファイルに異常があります',
            'msfier0001' => 'ファイル書式異常',
            'msfier0002' => '設定値無し(line =>%s col =>%s)',
            'msfier0003' => '形式異常(line =>%s col =>%s)',
            'msfier0004' => '設定値異常(line =>%s col =>%s)',
            'msfier0005' => '該当部署無し(line =>%s col =>%s)',
            'msfier0006' => '該当人員無し(line =>%s col =>%s)',
            'msfier0007' => '該当作業場所無し(line =>%s col =>%s)',
            'msfier0008' => '該当作業定義無し(line =>%s col =>%s)',
            'msfier0009' => '該当作業指示無し(line =>%s col =>%s)',
            'msfier0010' => '該当作業進捗無し(line =>%s col =>%s)',
            'msfier0011' => '該当掲示板無し(line =>%s col =>%s)',
            ...
            'mhcmsi0001' => '処理開始',
            'mmnwok0002' => '送信試験用のメールアドレスでメール送信が成功しました',
            'mmnwok0003' => '受信サーバでメールが受信されました',
            'mmnwer0001' => '送信試験用のメールアドレスでメール送信が失敗しました',
            'mmnwer0002' => '受信サーバでメールが受信されませんでした',
            'mmnwer0003' => 'フォームに適当な値が入力されていません',
            'mmnwer0004' => 'フォームに値を入力してください。',
            'mmnwok0001' => '確定しました。',
]
